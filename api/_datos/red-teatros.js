export default JSON.parse(`
{
  ...
  "regenerar": "Junio y diciembre, cuando la Comunidad publica el semestre nuevo. OJO: el slug de madrid.org NO lleva guiones y a veces omite articulos (la-gran-aventura-del-pollo-pepe -> granaventurapollopepe), asi que url/imagen NO se pueden deducir del campo slug de aqui: copialos del href real del listado. El slug local solo genera el id (redteatros-<slug>) y no debe cambiarse.",
  "eventos": [
    {
