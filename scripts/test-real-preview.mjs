...
console.log('BYPASS_SECRET:', BYPASS_SECRET ? '✓ cargado' : '❌ FALTA')
console.log('DATABASE_URL:', process.env.DATABASE_URL ? '✓ cargado' : '❌ FALTA')

if (!process.env.DATABASE_URL || !BYPASS_SECRET) {
